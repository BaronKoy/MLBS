...
freq <- read_csv('/home/baron/Documents/PhD/ML_balancingselection_data/abi_raw_data/BAMs/final.txt', #change for specific alignment file
...
line_plot <- ggplot(freq, aes(x = pos, y = mapping_quality, color = Generation)) +
  ...
  theme_grey() +
  labs(title = 'Mapping quality across focal region, gen2-8', y = 'Mapping_quality', x = 'Genomic_position_(Chr_3R)') +
